...
def maize_upload():
    if request.method == 'POST':
        ...
        pest_list=[mp1,'ग्रीन स्टिंक बग','मक्का बेधक',mp4,'गुलाबी तना बेधक (Pink Stem Corer)', 'स्पोडोप्टेरा लिटुरा','अपलोड की गई छवि डेटासेट पर उपलब्ध नहीं है', 'स्वस्थ मकई का पत्ता, अगर प्रभावित हिस्सा है तो फिर से तस्वीर अपलोड करें']    
...
def rice_upload():
    if request.method == 'POST':
        ...
        pest_list=['बीट वेबवर्म',rp2,'यूबलम्मा',rp4,rp5,'हॉर्न कैटरपिलर',rp7,'राइस मील्यबग','राइस स्किपर',rp10,'येलो टेल मोत','अपलोड की गई तस्वीर डेटासेट पर उपलब्ध नहीं है', 'स्वस्थ चावल का पत्, अगर प्रभावित हिस्सा है तो फिर से तस्वीर अपलोड करे']    
